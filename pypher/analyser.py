...
class Analyser(ABC):
    ...
    def ocurs_chars(cls, message: str, percent: bool = False, reverse: bool = False) -> dict[str, float]:
        ...
        Args:
            ...
            percent (bool, optional): if the ocurences need to be specied as percent. Defaults to False.
            reverse (bool, optional): dict sort in reverse order. Defaults to False.
